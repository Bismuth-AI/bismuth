"""The agent loop and its permission gate."""
...
import bismuth.agentkit as agentkit
from bismuth.agentkit import Agent, FunctionTool, Permission, ToolRegistry, tool, tool_spec
...
class TestSubAgent:
    async def test_task_delegates_and_returns_only_the_final_text(self) -> None:
        from bismuth.agentkit import subagent_tool
    ...
    async def test_delegation_depth_is_bounded(self) -> None:
        from bismuth.agentkit.subagent import _depth, subagent_tool
